...
router.patch("/groups/:groupId/smart-split", asyncHandler(groupController.updateSmartSplit));
router.post("/groups/:groupId/leave", asyncHandler(groupController.leaveGroup));
